...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.depID}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.depName}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.HOD}</p>
...
<Column field="depID" header="DepID" body={pTemplate0} filter={selectedFilterFields.includes("depID")} hidden={selectedHideFields?.includes("depID")}  sortable style={{ minWidth: "8rem" }} />
<Column field="depName" header="DepName" body={pTemplate1} filter={selectedFilterFields.includes("depName")} hidden={selectedHideFields?.includes("depName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="HOD" header="HOD" body={pTemplate2} filter={selectedFilterFields.includes("HOD")} hidden={selectedHideFields?.includes("HOD")}  sortable style={{ minWidth: "8rem" }} />
