...
const DepartmentDetailsPage = (props) => {
    ...
    const service = _.find(config.services, { serviceName : "departmentDetails"});
        ...
        <div className="mt-5">
            <div className="grid">
                <div className="col-6 flex justify-content-start">
                    <h3 className="mb-0 ml-2">DepartmentDetails </h3>
                </div>
                <div className="col-6 flex justify-content-end">
                    <>
                    <Button label="add" loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="departmentDetails-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="departmentDetails-datatable">
...
/>
            ...
            <DepartmentDetailsCreateDialogComponent entity={newRecord} show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
