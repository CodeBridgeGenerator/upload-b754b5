...
address: _entity?.address,
        ...
        const result = await client.service("lecturerDetails").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info lecturerDetails updated successfully" });
    ...
    return (
        <Dialog header="Edit LecturerDetails" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="lecturerDetails-edit-dialog-component">
