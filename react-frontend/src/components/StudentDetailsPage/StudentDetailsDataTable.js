...
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.courseId}</p>
...
<Column field="courseId" header="CourseId" body={pTemplate3} filter={selectedFilterFields.includes("courseId")} hidden={selectedHideFields?.includes("courseId")}  sortable style={{ minWidth: "8rem" }} />
